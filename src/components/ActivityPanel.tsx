        ...
        <header className="flex items-center justify-between mb-4 min-w-0">
          <nav className="flex bg-gradient-to-r from-slate-100/10 to-blue-100/10 rounded-xl p-1 border border-blue-200/30 shadow-lg flex-1 max-w-md min-w-0">
            <button
              ...
              className={cn(
                "flex-1 py-2 px-2 sm:px-3 text-xs sm:text-sm font-semibold transition-all duration-300 relative whitespace-nowrap min-w-0 rounded-xl",
                activeTab === "orders"
            ...
            <button
              ...
              className={cn(
                "flex-1 py-2 px-3 text-xs sm:text-sm font-semibold transition-all duration-300 relative whitespace-nowrap min-w-0 rounded-xl",
                activeTab === "trades"
                  ? "bg-gradient-to-r from-blue-500 via-indigo-500 to-purple-500 text-white shadow-xl"
                  : "text-slate-600 hover:text-slate-800 hover:bg-white/80 hover:shadow-md",
              )}
          ...
          {(activeTab === "trades" || activeTab === "orders") && (
            <nav className="flex bg-gradient-to-r from-slate-100/10 to-blue-100/10 rounded-xl p-1 border border-blue-200/30 shadow-lg ml-2 sm:ml-3 min-w-0">
              <button
                ...
                className={cn(
                  "px-2 sm:px-3 py-2 text-xs font-semibold rounded-xl transition-all duration-300",
                  !showMineOnly
            ...
            >
              ...
              <header className="grid grid-cols-4 sm:grid-cols-5 text-xs text-neutral-600 py-2 border-b border-gray-200 gap-1 sm:gap-2 rounded-t-xl min-w-0">
                <button
                  ...
                  className="text-right truncate hover:text-blue-600  transition-all duration-300 flex items-center justify-end gap-1 group cursor-pointer font-semibold min-w-0"
                >
                  💰 Price
                  {getSortIcon("price")}
                </button>
                <button
                  ...
                  className="text-right truncate hover:text-emerald-600  transition-all duration-300 flex items-center justify-end gap-1 group cursor-pointer font-semibold min-w-0"
                >
                  📊 Amount
                ...
                <button
                  ...
                  className="text-right truncate hover:text-purple-600  transition-all duration-300 flex items-center justify-end gap-1 group cursor-pointer font-semibold min-w-0"
                >
                  ⏰ Time
                  {getSortIcon("time")}
                </button>
