...
export const file_arborter: GenFile = /*@__PURE__*/
  fileDesc("");
 ...
 *
 * @generated from message xyz.aspens.arborter.v1.SetOrderbookRequest
 */
export type SetOrderbookRequest = Message<"xyz.aspens.arborter.v1.SetOrderbookRequest"> & {
  /**
...
/**
 * Describes the message xyz.aspens.arborter.v1.SetOrderbookRequest.
 * Use `create(SetOrderbookRequestSchema)` to create a new message.
 */
export const SetOrderbookRequestSchema: GenMessage<SetOrderbookRequest> = /*@__PURE__*/
  messageDesc(file_arborter, 12);

/**
 * Response for setting a new orderbook
 *
 * @generated from message xyz.aspens.arborter.v1.SetOrderbookResponse
 */
export type SetOrderbookResponse = Message<"xyz.aspens.arborter.v1.SetOrderbookResponse"> & {
  /**
...
/**
 * Describes the message xyz.aspens.arborter.v1.SetOrderbookResponse.
 * Use `create(SetOrderbookResponseSchema)` to create a new message.
 */
export const SetOrderbookResponseSchema: GenMessage<SetOrderbookResponse> = /*@__PURE__*/
 ...
 *
 * @generated from message xyz.aspens.arborter.v1.ChainPublicKey
 */
export type ChainPublicKey = Message<"xyz.aspens.arborter.v1.ChainPublicKey"> & {
  /**
   * The chain ID
   *
...
/**
 * Describes the message xyz.aspens.arborter.v1.ChainPublicKey.
...
export type GetSignerPublicKeyResponse = Message<"xyz.aspens.arborter.v1.GetSignerPublicKeyResponse"> & {
   ...
   *
   * @generated from field: map<uint32, xyz.aspens.arborter.v1.ChainPublicKey> chain_keys = 1;
   */
...
export const ArborterService: GenService<{
  ...
  setOrderbook: {
    methodKind: "unary";
    input: typeof SetOrderbookRequestSchema;
    output: typeof SetOrderbookResponseSchema;
  },
  /**
