...
export function getTokenImageUrl(symbol: string): string | null {
  ...
  const tokenImages: Record<string, string> = {
    ...
    WMATIC:
      "https://assets.coingecko.com/coins/images/4713/standard/matic-token-icon.png", // Wrapped MATIC shows MATIC logo
    ...
    MATIC:
      "https://assets.coingecko.com/coins/images/4713/standard/matic-token-icon.png",
