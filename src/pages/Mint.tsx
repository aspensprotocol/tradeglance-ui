    ...
    <Layout footerPosition="absolute">
      <main className="max-w-4xl mx-auto px-3 sm:px-4 lg:px-6">
        <header className="mb-6 sm:mb-8">
          <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-2">Test Token Minting</h1>
                ...
                return (
                  <Card key={`${chain.chainId}-${tokenSymbol}`} className="border-2 border-gray-200">
                    <CardHeader>
                      ...
                      <small className="text-xs text-gray-400">Chain ID: {chain.chainId}</small>
                    </CardHeader>
