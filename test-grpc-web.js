const { ConfigServiceClient } = require('./src/proto/grpc_web/arborter_config_grpc_web_pb');
const { GetConfigRequest, Empty } = require('./src/proto/grpc_web/arborter_config_pb');
